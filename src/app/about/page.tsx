    ...
    <main>
      ...
      <div style={pageStyle}>
        ...
        <section style={{ padding: '120px 48px' }}>
          ...
          <h2 style={{ fontFamily: 'var(--font-syne)', fontSize: '3rem', marginBottom: '60px' }}>Core Values</h2>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '24px' }}>
            {values.map((v, i) => (
              <RevealWrapper key={i} delayIndex={i}>
        ...
        <section style={{ padding: '120px 48px', background: 'var(--gray)' }}>
          ...
          <h2 style={{ fontFamily: 'var(--font-syne)', fontSize: '3rem', marginBottom: '60px' }}>Meet The Team</h2>
